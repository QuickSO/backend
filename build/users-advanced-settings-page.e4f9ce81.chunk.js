(self["webpackChunkquickso_cms"] = self["webpackChunkquickso_cms"] || []).push([[8754],{
...
const schema = yup_lib/* object */.Ik().shape({
  email_confirmation_redirection: yup_lib/* mixed */.gl().when("email_confirmation", {
    is: true,
    then: yup_lib/* string */.Yj().matches(URL_REGEX).required(),
    otherwise: yup_lib/* string */.Yj().nullable()
  }),
  email_reset_password: yup_lib/* string */.Yj(build.translatedErrors.string).matches(URL_REGEX, build.translatedErrors.regex).nullable()
});
...
const fetchData = () => __async(void 0, null, function* () {
  const { data } = yield utils/* axiosInstance */.SP.get((0,utils/* getRequestURL */.X3)("advanced"));
  return data;
});
const putAdvancedSettings = (body) => {
  return utils/* axiosInstance */.SP.put((0,utils/* getRequestURL */.X3)("advanced"), body);
};
...
const ProtectedAdvancedSettingsPage = () => /* @__PURE__ */ react.createElement(build.CheckPagePermissions, { permissions: permissions/* default */.A.readAdvancedSettings }, /* @__PURE__ */ react.createElement(AdvancedSettingsPage, null));
const AdvancedSettingsPage = () => {
  ...
  const updatePermissions = (0,react.useMemo)(
    () => ({ update: permissions/* default */.A.updateAdvancedSettings }),
    []
  );
  const {
