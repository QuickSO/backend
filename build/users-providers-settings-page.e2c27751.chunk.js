(self["webpackChunkquickso_cms"] = self["webpackChunkquickso_cms"] || []).push([[8750],{
...
const forms_forms = {
  email: {
    ...
    schema: yup_lib/* object */.Ik().shape({
      enabled: yup_lib/* bool */.lc().required(build.translatedErrors.required)
    })
  },
  providers: {
    form: [
    ...
    schema: yup_lib/* object */.Ik().shape({
      enabled: yup_lib/* bool */.lc().required(build.translatedErrors.required),
      key: yup_lib/* string */.Yj().when("enabled", {
        is: true,
        then: yup_lib/* string */.Yj().required(build.translatedErrors.required),
        otherwise: yup_lib/* string */.Yj()
      }),
      secret: yup_lib/* string */.Yj().when("enabled", {
        is: true,
        then: yup_lib/* string */.Yj().required(build.translatedErrors.required),
        otherwise: yup_lib/* string */.Yj()
      }),
      callback: yup_lib/* string */.Yj().when("enabled", {
        is: true,
        then: yup_lib/* string */.Yj().required(build.translatedErrors.required),
        otherwise: yup_lib/* string */.Yj()
      })
  ...
  providersWithSubdomain: {
    ...
    schema: yup_lib/* object */.Ik().shape({
      ...
      subdomain: yup_lib/* string */.Yj().when("enabled", {
        is: true,
        then: yup_lib/* string */.Yj().required(build.translatedErrors.required),
        otherwise: yup_lib/* string */.Yj()
      }),
...
const fetchData = (toggleNotification) => __async(void 0, null, function* () {
  try {
    const { data } = yield utils/* axiosInstance */.SP.get((0,utils/* getRequestURL */.X3)("providers"));
    return data;
  } catch (err) {
    toggleNotification({
      type: "warning",
...
const putProvider = (body) => {
  return utils/* axiosInstance */.SP.put((0,utils/* getRequestURL */.X3)("providers"), body);
};
...
const ProvidersPage = () => {
  ...
  const updatePermissions = (0,react.useMemo)(() => {
    return { update: permissions/* default */.A.updateProviders };
  }, []);
  const {
...
const ProtectedProvidersPage = () => /* @__PURE__ */ react.createElement(build.CheckPagePermissions, { permissions: permissions/* default */.A.readProviders }, /* @__PURE__ */ react.createElement(ProvidersPage, null));
