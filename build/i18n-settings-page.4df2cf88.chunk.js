(self["webpackChunkquickso_cms"] = self["webpackChunkquickso_cms"] || []).push([[821],{
...
const localeFormSchema = (0,lib/* object */.Ik)().shape({
  code: (0,lib/* string */.Yj)().required(),
  displayName: (0,lib/* string */.Yj)().max(50, "Settings.locales.modal.locales.displayName.error").required(build.translatedErrors.required)
});
...
var constants = __webpack_require__(67801);
...
const useEditLocale = () => {
  ...
  const modifyLocale = (id, payload) => __async(void 0, null, function* () {
    ...
    dispatch({ type: constants/* UPDATE_LOCALE */.JX, editedLocale });
    setLoading(false);
  });
...
const BaseForm = ({ locale }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  const { values, handleChange, errors } = (0,formik_cjs_production_min.useFormikContext)();
...
const AdvancedForm = ({ isDefaultLocale }) => {
  const { values, setFieldValue } = (0,formik_cjs_production_min.useFormikContext)();
  const { formatMessage } = (0,react_intl.useIntl)();
...
const useDeleteLocale = () => {
  ...
  const removeLocale = (id) => useDeleteLocale_async(void 0, null, function* () {
    ...
    dispatch({ type: constants/* DELETE_LOCALE */.V2, id });
    setLoading(false);
  });
...
const useAddLocale = () => {
  ...
  const persistLocale = (locale) => useAddLocale_async(void 0, null, function* () {
    ...
    try {
      ...
      dispatch({ type: constants/* ADD_LOCALE */.TI, newLocale });
    } catch (e) {
...
const BaseForm_BaseForm = () => {
  const { formatMessage } = (0,react_intl.useIntl)();
  const { values, handleChange, setFieldValue, errors } = (0,formik_cjs_production_min.useFormikContext)();
...
const LocaleTable = ({ locales, onDeleteLocale, onEditLocale }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(Table.Table, { colCount: 4, rowCount: locales.length + 1 }, /* @__PURE__ */ react.createElement(Table.Thead, null, /* @__PURE__ */ react.createElement(Table.Tr, null, /* @__PURE__ */ react.createElement(Table.Th, null, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: (0,utils/* getTrad */.g)("Settings.locales.row.id") }))), /* @__PURE__ */ react.createElement(Table.Th, null, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: (0,utils/* getTrad */.g)("Settings.locales.row.displayName") }))), /* @__PURE__ */ react.createElement(Table.Th, null, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: (0,utils/* getTrad */.g)("Settings.locales.row.default-locale") }))), /* @__PURE__ */ react.createElement(Table.Th, null, /* @__PURE__ */ react.createElement(VisuallyHidden.VisuallyHidden, null, "Actions")))), /* @__PURE__ */ react.createElement(Table.Tbody, null, locales.map((locale) => /* @__PURE__ */ react.createElement(
    Table.Tr,
    __spreadValues({
      key: locale.id
    }, (0,build.onRowClick)({
    ...
    /* @__PURE__ */ react.createElement(Table.Td, null, /* @__PURE__ */ react.createElement(Typography.Typography, { textColor: "neutral800" }, locale.isDefault ? formatMessage({ id: (0,utils/* getTrad */.g)("Settings.locales.default") }) : null)),
...
const LocaleList = ({ canUpdateLocale, canDeleteLocale, onToggleCreateModal, isCreating }) => {
  ...
  return /* @__PURE__ */ react.createElement(Main.Main, { tabIndex: -1 }, /* @__PURE__ */ react.createElement(
    Layout.HeaderLayout,
    {
      primaryAction: /* @__PURE__ */ react.createElement(Button.Button, { startIcon: /* @__PURE__ */ react.createElement((Plus_default()), null), onClick: onToggleCreateModal, size: "S" }, formatMessage({ id: (0,utils/* getTrad */.g)("Settings.list.actions.add") })),
    ...
    Layout.EmptyStateLayout,
    {
      ...
      action: onToggleCreateModal ? /* @__PURE__ */ react.createElement(Button.Button, { variant: "secondary", startIcon: /* @__PURE__ */ react.createElement((Plus_default()), null), onClick: onToggleCreateModal }, formatMessage({ id: (0,utils/* getTrad */.g)("Settings.list.actions.add") })) : null
    }
...
var permissions = __webpack_require__(34515);
...
const ProtectedLocaleSettingsPage = () => {
  ...
  } = (0,build.useRBAC)(permissions/* default */.A);
  if (isLoading) {
    return null;
  }
  return /* @__PURE__ */ react.createElement(
