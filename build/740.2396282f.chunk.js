...
`])),_),U=j()(M.Flex)(p||(p=S()([`
  ...
  `,`
`])),function(z){return z.theme.colors.neutral600},.625,function(z){return z.theme.colors.primary600},F.a),P=l.a.forwardRef(function(z,X){var I=z.children,B=z.startIcon,A=z.endIcon,H=z.onClick,W=z.disabled,E=z.loading,G=g()(z,L),V=H&&!W?H:void 0,R=W||E;return l.a.createElement(U,d()({ref:X,"aria-disabled":R,onClick:V,as:"button",type:"button"},G),(B||E)&&l.a.createElement(s.Box,{as:"span",paddingRight:2,"aria-hidden":!0},E?l.a.createElement(Q,null,l.a.createElement(r.a,null)):B),l.a.createElement(C.Typography,{variant:"pi",textColor:R?"neutral600":"primary600"},I),A&&l.a.createElement(s.Box,{as:"span",paddingLeft:2,"aria-hidden":!0},A))});P.displayName="TextButton",P.defaultProps={disabled:!1,startIcon:void 0,endIcon:void 0,loading:!1,onClick:void 0},P.propTypes={children:b.a.node.isRequired,disabled:b.a.bool,endIcon:b.a.element,loading:b.a.bool,onClick:b.a.func,startIcon:b.a.element}}])})},80909:(y,k,h)=>{var x=h(30641),v=h(38329),m=v(x);y.exports=m},5128:(y,k,h)=>{var x=h(80909),v=h(64894);function m(t,f){var e=-1,o=v(t)?Array(t.length):[];return x(t,function(i,p,u){o[++e]=f(i,p,u)}),o}y.exports=m},46155:(y,k,h)=>{var x=h(34932),v=h(47422),m=h(15389),t=h(5128),f=h(73937),e=h(27301),o=h(43714),i=h(83488),p=h(56449);function u(d,c,g){c.length?c=x(c,function(a){return p(a)?function(l){return v(l,a.length===1?a[0]:a)}:a}):c=[i];var O=-1;c=x(c,e(m));var S=t(d,function(a,l,w){var b=x(c,function(T){return T(a)});return{criteria:b,index:++O,value:a}});return f(S,function(a,l){return o(a,l,g)})}y.exports=u},73937:y=>{function k(h,x){var v=h.length;for(h.sort(x);v--;)h[v]=h[v].value;return h}y.exports=k},53730:(y,k,h)=>{var x=h(44394);function v(m,t){if(m!==t){var f=m!==void 0,e=m===null,o=m===m,i=x(m),p=t!==void 0,u=t===null,d=t===t,c=x(t);if(!u&&!c&&!i&&m>t||i&&p&&d&&!u&&!c||e&&p&&d||!f&&d||!o)return 1;if(!e&&!i&&!c&&m<t||c&&f&&o&&!e&&!i||u&&f&&o||!p&&o||!d)return-1}return 0}y.exports=v},43714:(y,k,h)=>{var x=h(53730);function v(m,t,f){for(var e=-1,o=m.criteria,i=t.criteria,p=o.length,u=f.length;++e<p;){var d=x(o[e],i[e]);if(d){if(e>=u)return d;var c=f[e];return d*(c=="desc"?-1:1)}}return m.index-t.index}y.exports=v},38329:(y,k,h)=>{var x=h(64894);function v(m,t){return function(f,e){if(f==null)return f;if(!x(f))return m(f,e);for(var o=f.length,i=t?o:-1,p=Object(f);(t?i--:++i<o)&&e(p[i],i,p)!==!1;);return f}}y.exports=v},33031:(y,k,h)=>{var x=h(83120),v=h(46155),m=h(69302),t=h(36800),f=m(function(e,o){if(e==null)return[];var i=o.length;return i>1&&t(e,o[0],o[1])?o=[]:i>2&&t(o[0],o[1],o[2])&&(o=[o[0]]),v(e,x(o,1),[])});y.exports=f}}]);
