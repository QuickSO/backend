(self["webpackChunkquickso_cms"] = self["webpackChunkquickso_cms"] || []).push([[6719],{
...
"use strict";
  ...
  if (true) {
    module.exports = __webpack_require__(35871);
  } else {}
...
var utils = __webpack_require__(67487);
...
const fetchData = (toggleNotification, notifyStatus) => __async(void 0, null, function* () {
  try {
    const { data } = yield utils/* axiosInstance */.SP.get((0,utils/* getRequestURL */.X3)("roles"));
...
const deleteData = (id, toggleNotification) => __async(void 0, null, function* () {
  try {
    yield utils/* axiosInstance */.SP.delete(`${(0,utils/* getRequestURL */.X3)("roles")}/${id}`);
  } catch (error) {
    toggleNotification({
      type: "warning",
...
const RoleListPage = () => {
  ...
  const updatePermissions = (0,react.useMemo)(() => {
    return {
      create: permissions/* default */.A.createRole,
      read: permissions/* default */.A.readRoles,
      update: permissions/* default */.A.updateRole,
      delete: permissions/* default */.A.deleteRole
    };
  }, []);
  const {
  ...
  return /* @__PURE__ */ react.createElement(Layout.Layout, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, { name: pageTitle }), /* @__PURE__ */ react.createElement(Main.Main, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(
    Layout.HeaderLayout,
    {
      ...
      primaryAction: /* @__PURE__ */ react.createElement(build.CheckPermissions, { permissions: permissions/* default */.A.createRole }, /* @__PURE__ */ react.createElement(Button.Button, { onClick: handleNewRoleClick, startIcon: /* @__PURE__ */ react.createElement((Plus_default()), null), size: "S" }, formatMessage({
    ...
    components_TableBody,
    {
      sortedRoles,
      canDelete,
      permissions: permissions/* default */.A,
      setRoleToDelete,
...
const ProtectedRolesListPage = () => {
  return /* @__PURE__ */ react.createElement(build.CheckPagePermissions, { permissions: permissions/* default */.A.accessRoles }, /* @__PURE__ */ react.createElement(ListPage, null));
};
...
var getTrad = __webpack_require__(61843);
...
const MethodBox = (0,styled_components_browser_cjs["default"])((0,Box.Box))`
  margin: -1px;
...
const activeCheckboxWrapperStyles = (0,styled_components_browser_cjs.css)`
  background: ${(props) => props.theme.colors.primary100};
  svg {
    opacity: 1;
  }
`;
const CheckboxWrapper = (0,styled_components_browser_cjs["default"])((0,Box.Box))`
  display: flex;
...
var axiosInstance = __webpack_require__(41745);
  ...
  const fetchPlugins = (0,react.useCallback)(() => usePlugins_async(void 0, null, function* () {
    try {
      ...
      const [{ permissions: permissions2 }, { routes: routes2 }] = yield Promise.all(
        [`/${src_pluginId/* default */.A}/permissions`, `/${src_pluginId/* default */.A}/routes`].map((endpoint) => usePlugins_async(void 0, null, function* () {
          const res = yield axiosInstance/* default */.A.get(endpoint);
          return res.data;
        }))
      );
      dispatch({
        type: "GET_DATA_SUCCEEDED",
        permissions: (0,utils/* cleanPermissions */.mr)(permissions2),
        routes: routes2
      });
    } catch (err) {
...
/* provided dependency */ var useFetchRole_console = __webpack_require__(96763);
...
const useFetchRole = (id) => {
  ...
  const fetchRole = (roleId) => useFetchRole_async(void 0, null, function* () {
    try {
      const {
        data: { role }
      } = yield axiosInstance/* default */.A.get(`/${src_pluginId/* default */.A}/roles/${roleId}`);
      if (isMounted.current) {
        dispatch({
          type: "GET_DATA_SUCCEEDED",
          role
...
const schema = yup_lib/* object */.Ik().shape({
  name: yup_lib/* string */.Yj().required(build.translatedErrors.required),
  description: yup_lib/* string */.Yj().required(build.translatedErrors.required)
});
/* harmony default export */ const utils_schema = (schema);

;// CONCATENATED MODULE: ./node_modules/@strapi/plugin-users-permissions/admin/src/pages/Roles/EditPage/index.js
/* provided dependency */ var EditPage_console = __webpack_require__(96763);
...
const EditPage = () => {
  ...
  const {
    params: { id }
  } = (0,react_router_dom_min.useRouteMatch)(`/settings/${src_pluginId/* default */.A}/roles/:id`);
  ...
  const handleEditRoleSubmit = (data) => EditPage_async(void 0, null, function* () {
    ...
    try {
      ...
      yield axiosInstance/* default */.A.put(`/${src_pluginId/* default */.A}/roles/${id}`, EditPage_spreadProps(EditPage_spreadValues(EditPage_spreadValues({}, data), permissions), { users: [] }));
...
const ProtectedRolesEditPage = () => /* @__PURE__ */ react.createElement(build.CheckPagePermissions, { permissions: permissions/* default */.A.updateRole }, /* @__PURE__ */ react.createElement(Roles_EditPage, null));
...
const schema_schema = yup_lib/* object */.Ik().shape({
  name: yup_lib/* string */.Yj().required(build.translatedErrors.required),
  description: yup_lib/* string */.Yj().required(build.translatedErrors.required)
});
...
/* provided dependency */ var CreatePage_console = __webpack_require__(96763);
...
const CreatePage_EditPage = () => {
  ...
  const handleCreateRoleSubmit = (data) => CreatePage_async(void 0, null, function* () {
    ...
    try {
      ...
      yield axiosInstance/* default */.A.post(`/${src_pluginId/* default */.A}/roles`, CreatePage_spreadProps(CreatePage_spreadValues(CreatePage_spreadValues({}, data), permissions2), { users: [] }));
...
const ProtectedRolesCreatePage = () => /* @__PURE__ */ react.createElement(build.CheckPagePermissions, { permissions: permissions/* default */.A.createRole }, /* @__PURE__ */ react.createElement(CreatePage, null));
...
const Roles = () => {
  return /* @__PURE__ */ react.createElement(build.CheckPagePermissions, { permissions: permissions/* default */.A.accessRoles }, /* @__PURE__ */ react.createElement(react_router_dom_min.Switch, null, /* @__PURE__ */ react.createElement(
  ...
  ), /* @__PURE__ */ react.createElement(react_router_dom_min.Route, { path: `/settings/${src_pluginId/* default */.A}/roles/:id`, component: ProtectedEditPage, exact: true }), /* @__PURE__ */ react.createElement(react_router_dom_min.Route, { path: `/settings/${src_pluginId/* default */.A}/roles`, component: ProtectedListPage, exact: true }), /* @__PURE__ */ react.createElement(react_router_dom_min.Route, { path: "", component: build.NotFound })));
};
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  SP: () => (/* reexport */ axiosInstance/* default */.A),
...
// EXTERNAL MODULE: ./node_modules/@strapi/plugin-users-permissions/admin/src/pluginId.js
var pluginId = __webpack_require__(73658);
