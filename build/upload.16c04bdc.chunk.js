(self["webpackChunkquickso_cms"] = self["webpackChunkquickso_cms"] || []).push([[1188],{
...
var utils = __webpack_require__(83531);
...
var useMediaLibraryPermissions = __webpack_require__(57885);
// EXTERNAL MODULE: ./node_modules/@strapi/plugin-upload/admin/src/hooks/useFolder.js
var useFolder = __webpack_require__(21090);
...
var constants = __webpack_require__(25043);
// EXTERNAL MODULE: ./node_modules/@strapi/plugin-upload/admin/src/utils/getTrad.js
var getTrad = __webpack_require__(51887);
...
var useBulkRemove = __webpack_require__(22954);
...
var Folder = __webpack_require__(93987);
...
var pluginId = __webpack_require__(59902);
...
const useBulkMove = () => {
  ...
  const bulkMoveQuery = ({ destinationFolderId, filesAndFolders }) => {
    ...
    return utils/* axiosInstance */.SP.post(url, __spreadProps(__spreadValues({}, payload), { destinationFolderId }));
  };
...
const BulkMoveDialog = ({ onClose, selected, currentFolder }) => {
  ...
  const handleSubmit = (_0, _1) => BulkMoveDialog_async(void 0, [_0, _1], function* (values, { setErrors }) {
    try {
      ...
      const errors = (0,build.getAPIInnerErrors)(error, { getTrad: utils/* getTrad */.gT });
...
var FolderCard = __webpack_require__(90139);
...
var Breadcrumbs = __webpack_require__(26466);
...
var EmptyPermissions = __webpack_require__(2444);
...
var EmptyAssets = __webpack_require__(95722);
...
const BoxWithHeight = (0,styled_components_browser_cjs["default"])((0,Box.Box))`
  height: ${32 / 16}rem;
  display: flex;
  align-items: center;
`;
...
const MediaLibrary = () => {
  ...
  const {
    ...
    enabled: canRead && ((_a = assetsData == null ? void 0 : assetsData.pagination) == null ? void 0 : _a.page) === 1 && !(0,utils/* containsAssetFilter */.Ao)(query),
    query
  });
  const {
    data: currentFolder,
  ...
  } = (0,useFolder/* useFolder */.a)(query == null ? void 0 : query.folder, {
  ...
  return /* @__PURE__ */ react.createElement(Layout.Layout, null, /* @__PURE__ */ react.createElement(Main.Main, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(
    ...
    Layout.ActionLayout,
    {
      ...
      ), canRead && /* @__PURE__ */ react.createElement(SortPicker/* default */.A, { onChangeSort: handleChangeSort }), canRead && /* @__PURE__ */ react.createElement(Filters, null)),
    ...
    folders.map((folder) => {
      ...
      const url = (0,utils/* getFolderURL */._0)(pathname, query, folder);
