(self["webpackChunkquickso_cms"] = self["webpackChunkquickso_cms"] || []).push([[3881],{
...
var Play = __webpack_require__(53885);
...
const EventInput = ({ isDraftAndPublish }) => {
  ...
  const { values, handleChange: onChange } = (0,formik_cjs_production_min.useFormikContext)();
...
const HeadersInput = () => {
  const { formatMessage } = (0,react_intl.useIntl)();
  const { values, errors } = (0,formik_cjs_production_min.useFormikContext)();
  return /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 1 }, /* @__PURE__ */ react.createElement(Field.FieldLabel, null, formatMessage({
    ...
    formik_cjs_production_min.FieldArray,
    {
        ...
        return /* @__PURE__ */ react.createElement(Grid.Grid, { gap: 4 }, (_a = values.headers) == null ? void 0 : _a.map((header, i) => {
          ...
          return (
            ...
            /* @__PURE__ */ react.createElement(react.Fragment, { key: i }, /* @__PURE__ */ react.createElement(Grid.GridItem, { col: 6 }, /* @__PURE__ */ react.createElement(
              formik_cjs_production_min.Field,
              {
...
var Loader = __webpack_require__(10176);
...
const schema = yup_lib/* object */.Ik().shape({
  name: yup_lib/* string */.Yj(build.translatedErrors.string).required(build.translatedErrors.required).matches(NAME_REGEX, build.translatedErrors.regex),
  url: yup_lib/* string */.Yj(build.translatedErrors.string).required(build.translatedErrors.required).matches(URL_REGEX, build.translatedErrors.regex),
  headers: yup_lib/* lazy */.RZ((array) => {
    let baseSchema = yup_lib/* array */.YO();
    if (array.length === 1) {
    ...
    return baseSchema.of(
      yup_lib/* object */.Ik().shape({
        key: yup_lib/* string */.Yj().required(build.translatedErrors.required),
        value: yup_lib/* string */.Yj().required(build.translatedErrors.required)
      })
    );
  }),
  events: yup_lib/* array */.YO()
});
...
const EditView = () => {
  ...
  const { isLoading: isLoadingForModels, collectionTypes } = (0,hooks/* useModels */.GB)();
  ...
  const {
    ...
    mutate
  } = (0,lib.useMutation)(() => utils/* axiosInstance */.SP.post(`/admin/webhooks/${id}/trigger`));
...
/* harmony import */ var _permissions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(84060);
/* harmony import */ var _EditView__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(21114);




const ProtectedCreateView = () => /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.CheckPagePermissions, { permissions: _permissions__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.settings.webhooks.create }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_EditView__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A, null));
...
const ProtectedEditView = () => /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.CheckPagePermissions, { permissions: _permissions__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.settings.webhooks.update }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_EditView__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A, null));
