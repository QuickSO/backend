"use strict";
(self["webpackChunkquickso_cms"] = self["webpackChunkquickso_cms"] || []).push([[6823],{
...
const ProtectedEditPage = () => {
  const permissions = (0,react.useMemo)(() => {
    return {
      read: src_permissions/* default */.A.settings.roles.read,
      update: src_permissions/* default */.A.settings.roles.update
    };
  }, []);
  const {
    isLoading,
