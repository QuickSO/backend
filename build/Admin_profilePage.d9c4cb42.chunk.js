"use strict";
(self["webpackChunkquickso_cms"] = self["webpackChunkquickso_cms"] || []).push([[7003],{
...
const fetchUser = () => __async(void 0, null, function* () {
  const { data } = yield utils/* axiosInstance */.SP.get("/admin/users/me");
  return data.data;
});
const putUser = (body) => __async(void 0, null, function* () {
  const dataToSend = omit_default()(body, ["confirmPassword", "currentTheme"]);
  const { data } = yield utils/* axiosInstance */.SP.put("/admin/users/me", dataToSend);
...
const schema = yup_lib/* object */.Ik().shape(users/* profileValidation */.pK);
  ...
  const submitMutation = (0,lib.useMutation)((body) => putUser(body), {
    onSuccess(data2) {
      return ProfilePage_async(this, null, function* () {
        ...
        const userDisplayName = data2.username || (0,src_utils/* getFullName */.dS)(data2.firstname, data2.lastname);
  ...
  return /* @__PURE__ */ react.createElement(Main.Main, { "aria-busy": isSubmittingForm }, /* @__PURE__ */ react.createElement(
    ...
    ({ errors, values, handleChange, isSubmitting }) => {
      return /* @__PURE__ */ react.createElement(build.Form, null, /* @__PURE__ */ react.createElement(
        Layout.HeaderLayout,
        {
          title: data.username || (0,src_utils/* getFullName */.dS)(data.firstname, data.lastname),
