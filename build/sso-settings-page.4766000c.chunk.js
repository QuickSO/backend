"use strict";
(self["webpackChunkquickso_cms"] = self["webpackChunkquickso_cms"] || []).push([[1926],{
...
const schema = lib/* object */.Ik().shape({
  autoRegister: lib/* bool */.lc().required(build.translatedErrors.required),
  defaultRole: lib/* mixed */.gl().when("autoRegister", (value, initSchema) => {
...
const ssoPermissions = __spreadProps(__spreadValues({}, permissions/* default */.A.settings.sso), {
  readRoles: permissions/* default */.A.settings.roles.read
});
const SingleSignOn = () => {
  ...
  const { roles } = (0,hooks/* useRolesList */.xo)(canReadRoles);
