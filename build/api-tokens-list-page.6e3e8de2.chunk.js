"use strict";
(self["webpackChunkquickso_cms"] = self["webpackChunkquickso_cms"] || []).push([[1007],{
...
const LinkStyled = (0,styled_components_browser_cjs["default"])((0,build.Link))`
  svg {
    path {
...
const ApiTokenListView = () => {
  ...
  const {
    ...
    () => __async(void 0, null, function* () {
      ...
      const {
        data: { data }
      } = yield utils/* axiosInstance */.SP.get(`/admin/api-tokens`);
  ...
  const deleteMutation = (0,lib.useMutation)(
    (id) => __async(void 0, null, function* () {
      yield utils/* axiosInstance */.SP.delete(`/admin/api-tokens/${id}`);
    }),
    {
      onSuccess() {
...
const ProtectedApiTokenListView = () => /* @__PURE__ */ react.createElement(build.CheckPagePermissions, { permissions: permissions/* default */.A.settings["api-tokens"].main }, /* @__PURE__ */ react.createElement(ListView, null));
