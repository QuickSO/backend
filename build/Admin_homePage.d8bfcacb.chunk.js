"use strict";
(self["webpackChunkquickso_cms"] = self["webpackChunkquickso_cms"] || []).push([[7675],{
...
const StepHomepage = ({ type, title, number, content, hasLine }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box.Box, null, /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(Box.Box, { minWidth: (0,build.pxToRem)(30), marginRight: 5 }, /* @__PURE__ */ react.createElement(StepNumber/* default */.A, { type, number })), /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "h3" }, formatMessage(title))), /* @__PURE__ */ react.createElement(Flex.Flex, { alignItems: "flex-start" }, /* @__PURE__ */ react.createElement(
    Flex.Flex,
    {
    ...
    hasLine && /* @__PURE__ */ react.createElement(StepLine/* default */.A, { type, minHeight: type === constants/* IS_ACTIVE */.mY ? (0,build.pxToRem)(85) : (0,build.pxToRem)(65) })
  ), /* @__PURE__ */ react.createElement(Box.Box, { marginTop: 2 }, type === constants/* IS_ACTIVE */.mY && content)));
};
...
const LinkCustom = (0,styled_components_browser_cjs["default"])((0,LinkButton.LinkButton))`
  display: flex;
  align-items: center;
  border: none;
...
`;
const GridGap = (0,styled_components_browser_cjs["default"])((0,Grid.Grid))`
...
const WordWrap = (0,styled_components_browser_cjs["default"])((0,Typography.Typography))`
  word-break: break-word;
`;
const StackCustom = (0,styled_components_browser_cjs["default"])((0,Stack.Stack))`
...
var InformationSquare = __webpack_require__(74046);
...
var FeatherSquare = __webpack_require__(63127);
...
const LogoContainer = (0,styled_components_browser_cjs["default"])((0,Box.Box))`
  position: absolute;
  top: 0;
  right: 0;
  img {
...
`;
const HomePage = () => {
  const { collectionTypes, singleTypes, isLoading: isLoadingForModels } = (0,hooks/* useModels */.GB)();
