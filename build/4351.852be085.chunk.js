"use strict";
(self["webpackChunkquickso_cms"] = self["webpackChunkquickso_cms"] || []).push([[4351],{
...
var locale = __webpack_require__(13004);
...
const schema = yup_lib/* object */.Ik().shape({
  name: yup_lib/* string */.Yj(build.translatedErrors.string).required(build.translatedErrors.required),
  type: yup_lib/* string */.Yj(build.translatedErrors.string).oneOf(["read-only", "full-access", "custom"]).required(build.translatedErrors.required),
  description: yup_lib/* string */.Yj().nullable(),
  lifespan: yup_lib/* number */.ai().integer().min(1).nullable().defined(build.translatedErrors.required)
});
...
const Regenerate = ({ onRegenerate, idToRegenerate }) => {
  ...
  const { regenerateData, isLoadingConfirmation } = (0,hooks/* useRegenerate */.g4)(idToRegenerate, onRegenerate);
...
var react_copy_to_clipboard_lib = __webpack_require__(59399);
// EXTERNAL MODULE: ./node_modules/@strapi/icons/Key.js
var Key = __webpack_require__(94220);
...
const ApiTokenCreateView = () => {
  ...
  } = (0,build.useRBAC)(permissions/* default */.A.settings["api-tokens"]);
    ...
    () => EditView_async(void 0, null, function* () {
      const [permissions, routes] = yield Promise.all(
        ["/admin/content-api/permissions", "/admin/content-api/routes"].map((url) => EditView_async(void 0, null, function* () {
          const { data } = yield core_utils/* axiosInstance */.SP.get(url);
          return data.data;
        }))
      );
      dispatch({
  ...
  const { status } = (0,lib.useQuery)(
    ...
    () => EditView_async(void 0, null, function* () {
      const {
        data: { data }
      } = yield core_utils/* axiosInstance */.SP.get(`/admin/api-tokens/${id}`);
  ...
  const handleSubmit = (body, actions) => EditView_async(void 0, null, function* () {
    ...
    try {
      const {
        data: { data: response }
      } = isCreating ? yield core_utils/* axiosInstance */.SP.post(`/admin/api-tokens`, EditView_spreadProps(EditView_spreadValues({}, body), {
        lifespan: body.lifespan && parseInt(body.lifespan, 10) ? parseInt(body.lifespan, 10) : body.lifespan,
        permissions: body.type === "custom" ? state.selectedActions : null
      })) : yield core_utils/* axiosInstance */.SP.put(`/admin/api-tokens/${id}`, {
        name: body.name,
