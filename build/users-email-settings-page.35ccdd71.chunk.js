(self["webpackChunkquickso_cms"] = self["webpackChunkquickso_cms"] || []).push([[3064],{
...
const fetchData = () => __async(void 0, null, function* () {
  const { data } = yield utils/* axiosInstance */.SP.get((0,utils/* getRequestURL */.X3)("email-templates"));
  return data;
});
const putEmailTemplate = (body) => {
  return utils/* axiosInstance */.SP.put((0,utils/* getRequestURL */.X3)("email-templates"), body);
};
...
const schema = yup_lib/* object */.Ik().shape({
  options: yup_lib/* object */.Ik().shape({
    from: yup_lib/* object */.Ik().shape({
    ...
    response_email: yup_lib/* string */.Yj().email(build.translatedErrors.email),
    object: yup_lib/* string */.Yj().required(build.translatedErrors.required),
    message: yup_lib/* string */.Yj().required(build.translatedErrors.required)
...
const EmailForm = ({ template, onToggle, onSubmit }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(ModalLayout.ModalHeader, null, /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(Breadcrumbs.Crumb, null, formatMessage({ id: (0,utils/* getTrad */.gT)(template.display), defaultMessage: template.display }))
    )),
...
const ProtectedEmailTemplatesPage = () => /* @__PURE__ */ react.createElement(build.CheckPagePermissions, { permissions: permissions/* default */.A.readEmailTemplates }, /* @__PURE__ */ react.createElement(EmailTemplatesPage, null));
const EmailTemplatesPage = () => {
  ...
  const updatePermissions = (0,react.useMemo)(() => {
    return { update: permissions/* default */.A.updateEmailTemplates };
  }, []);
  const {
