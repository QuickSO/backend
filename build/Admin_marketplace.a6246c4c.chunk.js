(self["webpackChunkquickso_cms"] = self["webpackChunkquickso_cms"] || []).push([[9140],{
...
const EmptyPluginCard = (0,styled_components_browser_cjs["default"])((0,Box.Box))`
...
var Upload = __webpack_require__(25930);
...
var GlassesSquare = __webpack_require__(64020);
...
const InstallPluginButton = ({ isInstalled, isInDevelopmentMode, commandToCopy }) => {
  ...
  if (isInDevelopmentMode) {
    return /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(Button.Button, { size: "S", startIcon: /* @__PURE__ */ react.createElement((Duplicate_default()), null), variant: "secondary" }, formatMessage({
...
const EllipsisText = (0,styled_components_browser_cjs["default"])((0,Typography.Typography))`
...
const matchSearch = (npmPackages, search) => {
  return (0,match_sorter_cjs/* default */.Ay)(npmPackages, search, {
    keys: [
      {
        threshold: match_sorter_cjs/* default.rankings */.Ay.rankings.WORD_STARTS_WITH,
        key: "attributes.name"
      },
      { threshold: match_sorter_cjs/* default.rankings */.Ay.rankings.WORD_STARTS_WITH, key: "attributes.description" }
    ]
  });
};
...
const ProtectedMarketPlace = () => /* @__PURE__ */ react.createElement(build.CheckPagePermissions, { permissions: permissions/* default */.A.marketplace.main }, /* @__PURE__ */ react.createElement(MarketPlacePage, null));
