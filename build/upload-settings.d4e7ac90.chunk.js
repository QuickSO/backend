(self["webpackChunkquickso_cms"] = self["webpackChunkquickso_cms"] || []).push([[2714],{
...
var permissions = __webpack_require__(86974);
...
const SettingsPage = () => {
  ...
  (0,react.useEffect)(() => {
    ...
    const getData = () => __async(void 0, null, function* () {
      try {
        const {
          data: { data }
        } = yield utils/* axiosInstance */.SP.get((0,utils/* getRequestUrl */.rh)("settings"), {
  ...
  const handleSubmit = (e) => __async(void 0, null, function* () {
    ...
    try {
      yield utils/* axiosInstance */.SP.put((0,utils/* getRequestUrl */.rh)("settings"), modifiedData);
      dispatch({
