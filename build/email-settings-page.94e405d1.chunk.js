(self["webpackChunkquickso_cms"] = self["webpackChunkquickso_cms"] || []).push([[9051],{
...
var getTrad = __webpack_require__(83410);
...
const schema = lib/* object */.Ik().shape({
  email: lib/* string */.Yj().email(build.translatedErrors.email).required(build.translatedErrors.required)
});
/* harmony default export */ const utils_schema = (schema);

// EXTERNAL MODULE: ./node_modules/@strapi/plugin-email/admin/src/permissions.js
var permissions = __webpack_require__(10559);
...
const ProtectedSettingsPage = () => /* @__PURE__ */ react.createElement(build.CheckPagePermissions, { permissions: permissions/* default */.A.settings }, /* @__PURE__ */ react.createElement(SettingsPage, null));
const SettingsPage = () => {
  var _a, _b;
    ...
    /* @__PURE__ */ react.createElement(Stack.Stack, { spacing: 4 }, /* @__PURE__ */ react.createElement(Typography.Typography, { variant: "delta", as: "h2" }, formatMessage({
      ...
      TextInput.TextInput,
      {
        ...
        error: ((_a = formErrors.email) == null ? void 0 : _a.id) && formatMessage({
          id: (0,getTrad/* default */.A)(`${(_b = formErrors.email) == null ? void 0 : _b.id}`),
